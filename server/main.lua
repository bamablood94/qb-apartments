...
RegisterNetEvent('apartments:server:CreateApartment', function(type, label)
    ...
    TriggerClientEvent('okokNotify:Alert', src, 'Congradulations!', Lang:t('success.receive_apart')..' ('..label..')', 5000, 'success')
...
RegisterNetEvent('apartments:server:UpdateApartment', function(type, label)
    ...
    TriggerClientEvent('okokNotify:Alert', src, 'Congradulations!', Lang:t('success.changed_apart'), 5000, 'success')
    TriggerClientEvent("apartments:client:SetHomeBlip", src, type)
end)
